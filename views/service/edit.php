        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4><i class="bi bi-pencil"></i> Editar Servicio</h4>
                </div>
                <div class="card-body">
                    <form method="POST">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre"
                                    value="<?= htmlspecialchars($service['nombre']) ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="precio" class="form-label">Precio</label>
                                <input type="number" step="0.01" class="form-control" id="precio" name="precio"
                                    value="<?= $service['precio'] ?>" required>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label for="descripcion" class="form-label">Descripción</label>
                            <textarea class="form-control" id="descripcion" name="descripcion" rows="3" required><?= htmlspecialchars($service['descripcion']) ?></textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="grabaciones" name="grabaciones"
                                    value="<?= htmlspecialchars($service['grabaciones']) ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="estrategia_publicitaria" name="estrategia_publicitaria"
                                    value="<?= htmlspecialchars($service['estrategia_publicitaria']) ?>">
                            </div>
                        </div>
